...
public class Login_Score_Activity extends AppCompatActivity implements TextWatcher, View.OnClickListener, Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_score_login);

        client = new OkHttpClient.Builder().proxy(Proxy.NO_PROXY).build();
        et_username = findViewById(R.id.et_scoreUsername);
        et_password = findViewById(R.id.et_scorePassword);
        cb_remember = findViewById(R.id.cb_scoreRemember);
        btn_login = findViewById(R.id.btn_scoreLogin);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.btn_scoreLogin) {
            login();
        }
    }
